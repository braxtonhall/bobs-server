...
const environmentSchema = z.object({
	...
	SUBSCRIPTION_DIGEST_INTERVAL_HOURS: z.coerce.number().int().nonnegative().default(4),
	SUBSCRIPTION_DIGEST_DELAY_HOURS: z.coerce.number().int().nonnegative().default(12),
});
