...
INSERT INTO "new_Season" ("boxId", "description", "id", "name", "ownerId", "ruleCount", "sort", "state") SELECT "boxId", "description", "id", "name", "ownerId", "ruleCount", "sort", "state" FROM "Season";
DROP TABLE "Season";
