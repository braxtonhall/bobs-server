...
INSERT INTO "new_Favourite" ("episodeId", "rank", "viewerId") SELECT "episodeId", "rank", "viewerId" FROM "Favourite";
...
CREATE TABLE "new_Follow" (
    ...
    CONSTRAINT "Follow_createdAtId_fkey" FOREIGN KEY ("createdAtId") REFERENCES "Event" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_Opinion" ("episodeId", "liked", "rating", "viewerId") SELECT "episodeId", "liked", "rating", "viewerId" FROM "Opinion";
DROP TABLE "Opinion";
...
CREATE TABLE "new_View" (
    ...
    CONSTRAINT "View_createdAtId_fkey" FOREIGN KEY ("createdAtId") REFERENCES "Event" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_ViewLike" (
    ...
    CONSTRAINT "ViewLike_createdAtId_fkey" FOREIGN KEY ("createdAtId") REFERENCES "Event" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Viewing" (
    ...
    CONSTRAINT "Viewing_startedAtId_fkey" FOREIGN KEY ("startedAtId") REFERENCES "Event" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
